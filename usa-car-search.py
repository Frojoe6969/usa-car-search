...
def scrape_cargurus(page, url=None):
    ...
    for parsed in dom_candidates:
        ...
        # States within ~200mi of Rochester NY (14450): NY, PA, NJ, CT, MA, VT, NH, ME, RI, MD, DE
        if parsed.get("distance") is None:
...
def scrape_ebay(ctx):
    ...
    for card in cards:
        ...
        # Location/ZIP from card text ("from 14450" or city, ST)
...
# ── eBay Browse API ──────────────────────────────────────────────────────────
EBAY_APP_ID = "JosephGi-Openclaw-PRD-3dcf40d80-36aa1052"
...
EBAY_CLIENT_ID    = "JosephGi-Openclaw-PRD-3dcf40d80-36aa1052"
EBAY_CLIENT_SECRET= "PRD-dcf40d8000ba-e24b-4d16-8d30-5dd1"
EBAY_RUNAME       = "Joseph_Gialanel-JosephGi-Opencl-usmhts"
